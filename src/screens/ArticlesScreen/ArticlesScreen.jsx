...
export default class ArticlesScreen extends Component {
    ...
    handleClearArticles = () => {
        const { dispatch } = this.props;
        dispatch({ type: types.CLEAR_ARTICLES })
    }
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <NavigationEvents
                    onWillFocus={this.handleGetArticles}
                    onWillBlur={this.handleClearArticles}
                />
                        ...
                        return (
                            <Fragment>
                                <View style={styles.card}>
                                    ...
                                    >
                                        <Card.Title style={{ fontSize: 20 }}>{item.metadata.headline}</Card.Title>
                                        <Card.Image
...
ArticlesScreen.navigationOptions = () => {
    return {
      title: 'Articles',
      tabBarIcon: <SimpleLineIcons name='energy' size={15}/>
    };
};
